                ...
                @else
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        @foreach ($stores AS $store)
                            <div class="col">
                                <div class="card">
                                    <div class="card-header p-2 d-flex align-items-start">
                                        <div>
                                            <img class="card-img store-logo" src="{{ asset('storage/stores/logos/'.($store->logo ?? 'placeholder.png')) }}" title="Store Logo">
                                        </div>
                                        <div class="ms-2">
