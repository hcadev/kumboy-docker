    ...
    <div class="col-12 px-3">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="{{ isset($formData['name']) ? $formData['name'] : old('name') }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="text" name="contact_number" class="form-control" value="{{ isset($formData['contact_number']) ? $formData['name'] : old('contact_number') }}">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="open_until" class="form-control" value="{{ isset($formData['open_until']) ? $formData['open_until'] : old('open_until') }}">
                <div class="form-text">
                    Select a date for when the store closes. This cannot be changed freely. If you wish to do so, you will need to apply for a renewal and set a new date.
                </div>
                @error('open_until')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
